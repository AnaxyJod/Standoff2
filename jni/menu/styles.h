...
ImVec4 ThemeColor = ImVec4(0.26f, 0.59f, 0.98f, 1.0f);
...
void CustomStyle()
{
    ...
    colors[ImGuiCol_FrameBg]                = ImVec4(0.25f, 0.25f, 0.25f, 0.60f);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.35f, 0.35f, 0.35f, 0.60f);
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.40f, 0.40f, 0.40f, 0.60f);
    colors[ImGuiCol_TitleBg]                = ImVec4(0.15f, 0.15f, 0.15f, 0.95f);
    ...
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.35f, 0.35f, 0.35f, 0.60f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.40f, 0.40f, 0.40f, 0.60f);
    colors[ImGuiCol_Header]                 = ImVec4(0.30f, 0.30f, 0.30f, 0.80f);
    colors[ImGuiCol_HeaderHovered]          = ImVec4(0.40f, 0.40f, 0.40f, 0.80f);
    colors[ImGuiCol_HeaderActive]           = ImVec4(0.50f, 0.50f, 0.50f, 0.80f);
    ...
    colors[ImGuiCol_TabUnfocused]           = ImVec4(0.15f, 0.15f, 0.15f, 0.80f);
