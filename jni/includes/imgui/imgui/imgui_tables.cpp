...
void ImGui::TableAngledHeadersRowEx(float angle, float max_label_width)
{
    ...
    draw_list->AddRectFilled(table->BgClipRect.Min, table->BgClipRect.Max, GetColorU32(ImGuiCol_TableHeaderBg, 0.25f)); 
        ...
        for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
        {
            ...
            if (pass == 0)
            {
                ...
                if (column_n == highlight_column_n)
                    draw_list->AddQuadFilled(bg_shape[0], bg_shape[1], bg_shape[2], bg_shape[3], GetColorU32(ImGuiCol_Header)); 
